...
run_step "07b-mirror-app-repos.sh"     "Mirror app-repos/* → Gitea (demo apps)"
...
run_step "09c-build-demo-images.sh"    "Build + import demo-app images (app-repos/*/build.sh)"
